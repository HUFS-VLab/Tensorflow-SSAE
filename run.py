...
if __name__ == '__main__' :
    ...
    parser.add_argument('--dataset-name', type=str, default='SMD_2020', help='-')
    ...
    with tf.Graph().as_default():
        ...
        if args.test == False:
            ...
            print("=================================================")
            print(f"Model : SSAE(Trained by {target_name} ({len(trainData_list)} samples)")
            print(">>Model loaded")
